...
export default function MyInsurancePage() {
  ...
  const t = memberInsurancePlansTranslations[language];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="mt-8 rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-10 text-center">
            <p className="text-gray-600">{t.noPolicy}</p>
          </div>
          ...
          <div className="mt-8 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-md">
            ...
            <table className="w-full text-left text-sm">
              ...
              <thead className="bg-white text-xs uppercase text-gray-500">
                <tr>
                  <th className="px-6 py-3 font-semibold">{t.provider}</th>
                  <th className="px-6 py-3 font-semibold">{t.plan}</th>
                  <th className="px-6 py-3 font-semibold">{t.policyNumber}</th>
                  <th className="px-6 py-3 font-semibold">{t.coverage}</th>
