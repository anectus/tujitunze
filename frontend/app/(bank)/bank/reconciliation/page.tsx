...
export default function BankReconciliationPage() {
  ...
  const t = bankReconciliationTranslations[language];
  ...
  const handleUpload = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (records.length === 0) {
      setUploadError(t.pasteAtLeastOneRow);
      return;
    }
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.message || t.unableToRunReconciliation);
      }
      ...
      setUploadError(err instanceof Error ? err.message : t.unableToRunReconciliation);
    } finally {
      setUploading(false);
    }
  };
    ...
    <div>
      ...
      <div className="p-4 sm:p-8">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-md">
          ...
          <p className="text-lg font-bold text-gray-900">{t.uploadTitle}</p>
          ...
          {uploadResult && (
            <div className="mt-4 rounded-lg bg-blue-100 px-4 py-3 text-sm text-blue-700">
              Run #{uploadResult.runId}: {uploadResult.matchedCount} {t.resultMatched},{" "}
              {uploadResult.unmatchedCount} {t.resultUnmatchedOf} {uploadResult.totalUploaded}.
            </div>
          )}
        ...
        <div className="mt-6">
          ...
          <p className="mb-2 text-sm font-semibold text-gray-700">{t.historyTitle}</p>
              ...
              <table className="w-full text-left text-sm">
                ...
                <thead className="bg-gray-50 text-xs uppercase text-gray-500">
                  <tr>
                    ...
                    <th className="px-6 py-3 font-semibold">{t.unmatchedDiscrepant}</th>
