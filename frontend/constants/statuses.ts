...
// Generic partner-tenant operational status (Bank/Telecom/Insurance own
// profile pages) — Active/Inactive/Suspended regardless of tenant type.
export const PARTNER_STATUS: Record<string, StatusStyle> = {
  active: statusStyle("Active", "success"),
  inactive: statusStyle("Inactive", "neutral"),
  suspended: statusStyle("Suspended", "danger"),
};
