...
export default function HeroIllustration() {
  return (
    ...
    >
      ...
      {/* Back phone — floats on an outer wrapper group; the CSS float
          animation's `transform` would otherwise replace (not compose
          with) this group's own `rotate(...)` SVG transform attribute. */}
      ...
      {/* Piggy bank */}
      <g className="[animation:float-slower_4.5s_ease-in-out_infinite] motion-reduce:[animation:none]">
      ...
      <g fill="#5eead4" className="[animation:float-slow_3.5s_ease-in-out_infinite] motion-reduce:[animation:none]">
